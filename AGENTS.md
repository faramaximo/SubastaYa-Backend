...
Este agents define el contexto técnico los principios arquitectónicos y las directrices obligatorias para cualquier agente inteligente o desarrollador que contribuya a la base de código de **SubastaYa**.
